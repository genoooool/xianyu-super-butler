...
extern "C" {
    ...
    fn xianyu_notifications_show(title: *const c_char, body: *const c_char, sound: bool);
}
...
pub fn show(title: &str, body: &str, sound: bool) -> Result<(), NulError> {
    ...
    unsafe { xianyu_notifications_show(title.as_ptr(), body.as_ptr(), sound) };
    Ok(())
}
