...
import {
  desktopNotificationsEnabled, getDesktopNotificationStatus,
  setDesktopNotifications, testDesktopNotification,
...
export default function DesktopNotificationSettings() {
  ...
  useEffect(() => {
    getDesktopNotificationStatus().then(status => setAvailable(status.available)).catch(() => {});
  }, []);
